...
- Scenario modeling now has executable baseline fork + structural edit behavior in `features/org-model-intelligence.feature` (`@SCN-01`, `@SCN-02`, `@S-SCN-01`).
- Scenario intelligence now includes deterministic scoring/ranking, structural diff against baseline, comparison tables, and executable constraint-aware readiness gating in `features/org-model-intelligence.feature` (`@SCN-03`, `@SCN-04`, `@SCN-05`, `@SCN-06`, `@S-SCN-02`, `@S-SCN-03`, `@S-SCN-04`, `@S-SCN-05`).
...
- Implemented behavior:
  ...
  - scenario-to-baseline diff emits deterministic add/remove/reparent changes with stable entity IDs and parent references
  - side-by-side scenario comparison returns ranked tabular metrics for baseline-compatible scenarios
